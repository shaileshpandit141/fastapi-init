...
class AsyncRepository[Model: SQLModel, CreateModel: SQLModel, UpdateModel: SQLModel]:
    """
    Generic asynchronous CRUD repository for SQLModel entities.

    This repository provides common create, read, update, delete, and utility
